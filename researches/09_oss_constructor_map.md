...
многострочного write (см. выше), правила безопасности гейтвея (только tailnet, exec-approvals) — и
можно выходить из пилота в рабочий контур. Fallback-цепочку моделей в OpenClaw строить НЕ на gemma.
