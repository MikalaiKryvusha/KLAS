# LOCAL NOMAD — Local AI Agent — Внешняя карта структуры
...
### Проект `F:\LOCAL_NOMAD\local_ai_agent\`
...
│   └── interview_001_project_setup.md   # 🟡 repo / лицензия / свобода замены стека
└── homeworks/     # задачи от агента человеку                             + README.md
```

### Окружение `F:\LOCAL_NOMAD\` (проект им управляет, но не владеет)
