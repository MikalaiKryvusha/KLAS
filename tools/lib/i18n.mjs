...
const DICT = {
  ru: {
    ...
    q_libs: 'Скачать базы знаний из каталога Kiwix (Википедия и др., офлайн)?',
    zim_search: 'Поиск по каталогу (напр. wikipedia, medicine; Enter — популярные для языка)',
    zim_fetching: 'Загружаю каталог Kiwix…',
    zim_none: 'В каталоге ничего не нашлось по запросу. Пропускаю базы знаний.',
    zim_pick: 'Отметьте базы знаний для скачивания:',
    zim_downloading: 'Качаю выбранные базы знаний в kiwixdb…',
  ...
  en: {
    ...
    q_libs: 'Download knowledge bases from the Kiwix catalog (Wikipedia etc., offline)?',
    zim_search: 'Search the catalog (e.g. wikipedia, medicine; Enter — popular for your language)',
    zim_fetching: 'Fetching the Kiwix catalog…',
    zim_none: 'Nothing found in the catalog for that query. Skipping knowledge bases.',
    zim_pick: 'Select knowledge bases to download:',
    zim_downloading: 'Downloading selected knowledge bases to kiwixdb…',
