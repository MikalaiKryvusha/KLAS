...
def main() -> int:
    ...
    # ⚠️ Третий элемент — написание, которым собран КОРПУС, а не имя персоны. У «Ариэль» они
    # расходятся: корпус собран как «Ариель», потому что Piper не выговаривает «Ариэль» (`plans/20`).
    # Ищем клипы по написанию корпуса, иначе не найдём ни одного.
    plan = [
        ("jarvis", "joy", "Джарвис",
