...
CASES = [
    ("jarvis", "jarvis"),               # v4: + слово обязано ЗАКАНЧИВАТЬ фразу
    ("jarvis_v3_short", "jarvis"),      # v3: + только короткие клипы (фильтр по длительности)
    ("jarvis_v2_cross", "jarvis"),      # v2: + перекрёстные негативы
    ("jarvis_v1_baseline", "jarvis"),   # v1: исходная
    ("joy", "joy"),
]
